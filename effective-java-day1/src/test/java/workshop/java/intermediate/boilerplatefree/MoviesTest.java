...
public class MoviesTest {
    ...
    private static Movie actionMovie() {
        return Movie.builder()
                    ...
                    .writer(asList(
                            new Person("Dave Callaham", "screenplay"),
                            new Person("Sylvester Stallone", "screenplay"),
                            new Person("Dave Callaham", "story")))
                    .actors(asList(
                            new Person("Sylvester Stallone"),
                            new Person("Jason Statham"),
                            new Person("Jet Li, Dolph Lundgren")))
